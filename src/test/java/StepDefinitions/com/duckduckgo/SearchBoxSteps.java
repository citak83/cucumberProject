...
public class SearchBoxSteps {
    ...
    @When("the user validate all results contain {string}")
    public void the_user_validate_all_results_contain(String text) {
    ...
    public void the_user_validate_number_of_result_is(int expectedInt) {
        Assert.assertEquals(expectedInt,page.searchResults.size());
